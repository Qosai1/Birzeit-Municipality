...
export default function EmployeesTableDB() {
  ...
  // Show loading state
  if (loading) {
    return <div className="employees-table-container">Loading employees...</div>;
  }

  // Show error state
  if (error) {
    return <div className="employees-table-container">Error: {error}</div>;
  }
