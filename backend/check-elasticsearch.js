...
async function checkConnection() {
  try {
    ...
    console.log("2️⃣ Getting cluster health...");
    ...
    console.log("3️⃣ Checking indices...");
    ...
    console.log("4️⃣ Checking document_embeddings index...");
    ...
    if (indexExists) {
      ...
      console.log(
        "   ⚠️  Index does not exist (will be created on first use)\n"
      );
    }
